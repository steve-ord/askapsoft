...
#ifndef ASKAP_ACCESSORS_SERVICE_CAL_SOLUTION_ACCESSOR_H
#define ASKAP_ACCESSORS_SERVICE_CAL_SOLUTION_ACCESSOR_H
...
/// @ingroup calibaccess
class ServiceCalSolutionAccessor : public CachedCalSolutionAccessor  {
public:
  /// @brief constructor
