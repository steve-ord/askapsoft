...
#ifndef ASKAP_ACCESSORS_SERVICE_CAL_SOLUTION_SOURCE_H
#define ASKAP_ACCESSORS_SERVICE_CAL_SOLUTION_SOURCE_H

#include <calibaccess/ICalSolutionSource.h>
#include <calibaccess/ServiceCalSolutionAccessor.h>
...
/// This class just creates an instance of the accessor and manages it.
/// @ingroup calibaccess
struct ServiceCalSolutionSource : public CalSolutionSourceStub {
  /// @brief constructor
