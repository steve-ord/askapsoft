...
casacore::MEpoch asMEpoch(const vector<string>& epoch)
{
...
casacore::MDirection asMDirection(const vector<string>& direction)
{
...
casacore::MPosition asMPosition(const vector<string>& position)
{
