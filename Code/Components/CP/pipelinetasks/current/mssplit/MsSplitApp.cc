                      ...
                      const LOFAR::ParameterSet& parset)
{
    ...
    const casacore::uLong maxBuf = parset.getUint32("bufferMB",4000u) * 1024 * 1024ul;
    ...
    const casacore::uLong maxBucketSize = std::max(8192ul,maxBuf/nTilesPerRow);
    if ((casacore::uLong)bucketSize > maxBucketSize) {
